...
export namespace Flag {
  ...
  export declare const OPENCODE_EXEC_SOCKET_PATH: string | undefined
...
// Dynamic getter for OPENCODE_EXEC_SOCKET_PATH
// This must be evaluated at access time, not module load time,
// because tests and external tooling may set this env var at runtime
Object.defineProperty(Flag, "OPENCODE_EXEC_SOCKET_PATH", {
  get() {
    return process.env["OPENCODE_EXEC_SOCKET_PATH"]
  },
  enumerable: true,
  configurable: false,
})
